...
def cash_on_delivery(request,id):
   # Move cart item to ordered product table
    try:
        ...
        return render(request,'mainapp/cod_success.html',context)
    except:
      ...
      payment.save()
       ...
       # Initialize the Razorpay client with your API keys
            ...
            if payment['status'] != 'captured':
                messages.info(request, 'Payment will be refund into your account within 3 working days')
...
#   payment = Payment.objects.get(order_id = order.order_number)
#   return render('mainapp/ordercancel.html')
...
def payments_completed(request):
    ...
    try:
        ...
        return render(request, 'mainapp/payment-success.html', context)
